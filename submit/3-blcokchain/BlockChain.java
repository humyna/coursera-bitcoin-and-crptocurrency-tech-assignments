...
public class BlockChain {
    ...
    private class BlockNode{
    	...
    	public ArrayList<BlockNode> childrenList;
    	public int height;
    ...
    public boolean addBlock(Block block) {
    	...
    	BlockNode parentBlockNode =  blockChain.get(wrap(preBlockHash));
    	...
    	int proposeHeight = parentBlockNode.height + 1;
    	if(proposeHeight <= maxHeightNode.height - CUT_OFF_AGE){
    		return false;
    	}
    	...
    	if(proposeHeight > maxHeightNode.height){
    ...
    private static ByteArrayWrapper wrap(byte[] byteArr){
    	return new ByteArrayWrapper(byteArr);
    }
}